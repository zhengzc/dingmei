...
INSERT INTO `dm_dataGroup` (`id`, `groupId`, `groupName`, `description`)
VALUES
	(1, '1', '活期存款利率', '利率就表现形式来说，是指一定时期内利息额同借贷资本总额的比率。利率是单位货币在单位时间内的利息水平，表明利息的多少。经济学家一直在致力于寻找一套能够完全解释利率结构和变化的理论。利率通常由国家的中央银行控制，在美国由联邦储备委员会管理。至今，所有国家都把利率作为宏观经济调控的重要工具之一。'),
